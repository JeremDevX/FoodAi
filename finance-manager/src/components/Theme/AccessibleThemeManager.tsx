...
export function AccessibleThemeManager() {
  ...
  const handleThemeChange = (themeId: Theme) => {
    ...
    announcement.textContent = `Thème changé en ${
  ...
  return (
    ...
    >
      <h3
        ...
        className="text-lg font-bold text-wcag-primary-text mb-4"
      >
      ...
      <div className="space-y-6">
        ...
        <fieldset>
          ...
          <div className="space-y-2" role="radiogroup">
            {themes.map((theme) => {
              ...
              const isEffective =
                effectiveTheme ===
                (theme.id === "system" ? systemTheme : theme.id);
              ...
              return (
                ...
                >
                  ...
                  />
                  <Icon
                    className="h-5 w-5 text-wcag-secondary-text"
                    aria-hidden="true"
                  />
                  <div className="flex-1">
                    ...
                    <div
                      ...
                      className="text-sm text-wcag-secondary-text"
                    >
                      {theme.description}
                      {isEffective && (
        ...
        <div className="p-4 bg-wcag-surface rounded-lg border border-wcag-border">
          <h4 className="font-medium text-wcag-primary-text mb-2 flex items-center">
            <CheckCircle
              className="h-4 w-4 mr-2 text-wcag-success"
              aria-hidden="true"
            />
        ...
        <div className="p-4 bg-wcag-surface rounded-lg border border-wcag-border">
          <h4 className="font-medium text-wcag-primary-text mb-2 flex items-center">
            <AlertCircle
              className="h-4 w-4 mr-2 text-wcag-info"
              aria-hidden="true"
            />
